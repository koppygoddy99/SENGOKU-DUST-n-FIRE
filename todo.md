...
- [ ] สร้างภาพตัวอย่างแผนที่ Dust & Fire แบบแบ่งเขตและติดชื่อแคว้นยุคเซ็นโกคุครบ 66 แคว้น ทั้งภาพรวมประเทศและภาพซูม โดยรอผู้ใช้อะนุมัติก่อนใส่เว็บ
- [ ] ใช้โครงแผนที่ Gokishichidō เพียงแหล่งเดียวสำหรับขอบเขตและป้ายชื่อแคว้นของภาพตัวอย่าง โดยไม่ผสมแผนที่หรือขอบเขตจากแหล่งอื่น
- [x] ตรวจและสรุปสถานะงานล่าสุดของ workflow ทั้ง 8 ทีม พร้อมระบุงานเสร็จ งานรออนุมัติ และงานค้าง
- [x] ออกแบบข้อเสนอกติกาการผ่านวัน Page และฤดู โดยเสนอเกณฑ์เวลาเชิงเรื่องก่อนเปลี่ยน implementation
- [x] ออกแบบ AI Narrative Contract สำหรับ Scene Clock, time validation และ LOG ที่เล่าต่อเนื่อง ก่อนปรับ prompt/schema จริง
- [x] ปรับอาชีพเริ่มต้น 10 แบบในเว็บ พร้อม mission Mastery สัมภาระ สถานะ อายุ 18–20 ปี และค่า Stat ที่สัมพันธ์กับอาชีพ/แรงดึงผู้เล่น
- [x] ปรับคำถามเปิดเรื่องเหลือภูมิหลังตัวละคร 2 ข้อโดยไม่เพิ่ม Stat และให้ข้อมูลมีผลเชิงเรื่องในอนาคต
- [x] ขยายหน้า Confirmation ให้สรุปตัวละคร ภารกิจแรก Mastery ทั้งหมด สัมภาระ และภูมิหลังตัวละคร
- [x] เปลี่ยนคำเรียกภารกิจประจำตัวเป็นภารกิจแรกในหน้าสร้างตัวละครและหน้าภารกิจ
- [x] เพิ่มลบเซฟ Local Save แบบต้องกดยืนยันสองจังหวะ พร้อม regression ป้องกันการลบโดยไม่ตั้งใจ
- [x] จัดทำผังและคำอธิบายหลังบ้านของหนึ่งตาการเล่น ตั้งแต่กด Roll 2D12 จนบันทึก narrative, XP, เวลา, ภารกิจ และ Local Save
...
- [x] เปลี่ยนชื่อเมนู Prepare เป็น Muster และคำไทยเป็น ทรัพยากร ใน navigation และข้อความที่เกี่ยวข้อง
- [x] ตรวจและอธิบายบทบาทจริงของทรัพย์สิน เสบียง และเครดิตในกติกาปัจจุบัน พร้อม regression ชื่อเมนู
...
- [x] เขียน Story Logs ใหม่ห้าฉากตาม Narrative Contract เดิมเพื่อให้ผู้ใช้คัด Golden Examples โดยยังไม่เพิ่มเข้า library
- [x] ปรับ Narrative Contract ให้บทสนทนามีชีวิต ใช้คำไทยง่ายและไม่มั่ว พร้อม regression และ push ขึ้น GitHub
