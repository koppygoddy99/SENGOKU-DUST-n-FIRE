...
AI อาจประเมินความยากเป็นตัวเลข แต่ client ต้อง canonicalize เป็น tier ที่มี guardrail. Action ที่เข้าสู่หน้าทอยต้องไม่ลดเป็น DN10 เพียงเพราะประโยคสั้น และคำเสี่ยงคำเดียวต้องไม่กระโดดเป็น DN22 โดยไม่ดูวิชา/การเตรียมตัว.

| DN | ระดับ | ใช้กับ |
|---:|---|---|
| 14 | Meaningful stakes / เดิมพันมีความหมาย | งานที่สำเร็จหรือพลาดแล้วฉากต้องขยับ |
| 18 | Guarded or traceable / อุปสรรคจริงหรือทิ้งร่องรอย | ด่าน ผู้คุม การตรวจ หรือการกระทำเสี่ยงที่มีพยาน/ข้อครหา |
| 22 | Compounded crisis / วิกฤตซ้อน | การผิดกฎหมายปะทะด่านหรือผู้คุม โดยไม่มี mastery ที่เกี่ยวหรือเครื่องมือที่ช่วย |
