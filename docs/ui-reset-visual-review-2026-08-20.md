...
ภาพ mobile ที่ 390 × 844 ยืนยันว่า header แตกบรรทัดตามพื้นที่อย่างเป็นระเบียบ CTA ยังคงอยู่เหนือ narrative paper และปุ่มบันทึก/หน้าที่บันทึกไม่เบียดกับชื่อสถานที่ ตัว narrative ใช้ความกว้างอ่านได้และเลื่อนต่อเนื่องกับหน้า จึงไม่พบ nested scroll หรือ CTA ถูกกลืนใต้บทละครใน viewport แรก
