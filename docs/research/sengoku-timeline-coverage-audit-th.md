...
| ปีที่มี record ผ่านการตรวจ | 70 ปี |
| ปีที่ไม่มี record ตรวจแล้ว | 79 ปี |
| Historical records ทั้งหมด | 126 รายการ |
| สงคราม | 26 รายการ |
| เหตุการณ์การเมือง/สังคม | 40 รายการ |
| ภัยพิบัติ/สภาพแวดล้อม | 60 รายการ |
...
|---|---:|---|
| `exact-date` | 47 | ใช้ได้ต่อเมื่อ campaign มี `historicalDate` ที่ผู้เล่นยืนยัน; scene day ที่ engine สร้างขึ้นเองใช้ไม่ได้ |
