...
| ปีที่มี record ผ่านการตรวจ | 71 ปี |
| ปีที่ไม่มี record ตรวจแล้ว | 78 ปี |
| Historical records ทั้งหมด | 131 รายการ |
| สงคราม | 26 รายการ |
| เหตุการณ์การเมือง/สังคม | 40 รายการ |
| ภัยพิบัติ/สภาพแวดล้อม | 65 รายการ |
...
|---|---:|---|
| `exact-date` | 51 | ใช้ได้ต่อเมื่อ campaign มี `historicalDate` ที่ผู้เล่นยืนยัน; scene day ที่ engine สร้างขึ้นเองใช้ไม่ได้ |
