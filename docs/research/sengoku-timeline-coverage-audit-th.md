...
| Historical records ทั้งหมด | 98 รายการ |
| สงคราม | 26 รายการ |
| เหตุการณ์การเมือง/สังคม | 40 รายการ |
| ภัยพิบัติ/สภาพแวดล้อม | 32 รายการ |
...
|---|---:|---|
| `exact-date` | 27 | ใช้ได้ต่อเมื่อ campaign มี `historicalDate` ที่ผู้เล่นยืนยัน; scene day ที่ engine สร้างขึ้นเองใช้ไม่ได้ |
