...
| Historical records ทั้งหมด | 103 รายการ |
| สงคราม | 26 รายการ |
| เหตุการณ์การเมือง/สังคม | 40 รายการ |
| ภัยพิบัติ/สภาพแวดล้อม | 37 รายการ |
...
|---|---:|---|
| `exact-date` | 31 | ใช้ได้ต่อเมื่อ campaign มี `historicalDate` ที่ผู้เล่นยืนยัน; scene day ที่ engine สร้างขึ้นเองใช้ไม่ได้ |
| `month` | 8 | ใช้เป็นบริบทของเดือนและฤดู ไม่ใช้เป็นวันตายตัว |
| `season` | 1 | ใช้เป็นสีสันของฤดูกาลเท่านั้น |
| `year` | 63 | ใช้เป็นบริบททั้งปี ไม่ผูกกับวันในฉาก |
