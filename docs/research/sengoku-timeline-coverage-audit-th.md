...
| ปีที่มี record ผ่านการตรวจ | 72 ปี |
| ปีที่ไม่มี record ตรวจแล้ว | 77 ปี |
| Historical records ทั้งหมด | 135 รายการ |
| สงคราม | 26 รายการ |
| เหตุการณ์การเมือง/สังคม | 40 รายการ |
| ภัยพิบัติ/สภาพแวดล้อม | 69 รายการ |
...
|---|---:|---|
| `exact-date` | 55 | ใช้ได้ต่อเมื่อ campaign มี `historicalDate` ที่ผู้เล่นยืนยัน; scene day ที่ engine สร้างขึ้นเองใช้ไม่ได้ |
| `month` | 11 | ใช้เป็นบริบทของเดือนและฤดู ไม่ใช้เป็นวันตายตัว |
| `season` | 1 | ใช้เป็นสีสันของฤดูกาลเท่านั้น |
| `year` | 68 | ใช้เป็นบริบททั้งปี ไม่ผูกกับวันในฉาก |
